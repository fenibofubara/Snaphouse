									...
									<div id="gallery" class="isotope-items-wrap lightgallery hover-center hover-boxed">
										...
										<div class="isotope-item fashion">
											...
											<div class="album-single-item">
												...
												<!-- Begin item cover -->
												<div class="asi-cover">
													<a class="asi-link lg-trigger" href="assets/img/beauty/5.jpg" data-exthumbnail="assets/img/beauty/5.jpg" data-sub-html="<h4>Lana Melray</h4><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>">
														<div class="asi-info">
															<h2 class="asi-title">Lana Melray</h2>
